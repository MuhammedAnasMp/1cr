    ...
    <div className="absolute top-4 right-4 z-20 flex flex-col gap-2">
      ...
      {selectedCount > 0 && (
        <button
          ...
          className="p-3 bg-white hover:bg-neutral-200 text-background rounded shadow-2xl flex items-center justify-center font-bold transition-transform hover:scale-105"
        ...
        <div className="fixed inset-0 z-50 bg-black/65 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-surface-container border border-outline-variant rounded-modal p-5 max-w-xs w-full shadow-2xl">
            <h4 className="text-sm font-bold text-white mb-3 flex items-center gap-2">
              <Search className="w-4 h-4 text-active-cyan" />
              Jump to Coordinate
            </h4>
            <form onSubmit={handleJump} className="space-y-3">
              ...
              <div className="flex items-center gap-2 pt-2">
                <button
                  type="submit"
                  className="flex-1 py-1.5 bg-white hover:bg-neutral-200 text-background font-bold text-xs rounded transition-colors"
                >
                  Jump View
                </button>
                <button
                  ...
                  className="px-3 py-1.5 bg-surface-container-highest hover:bg-surface-bright text-white text-xs rounded border border-outline-variant transition-colors"
                >
                  Cancel
                </button>
              </div>
